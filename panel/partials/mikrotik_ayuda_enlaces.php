...
<div id="ayuda-enlaces-mikrotik" class="nc-card p-4 border-secondary border-opacity-25">
    ...
    <ul class="small mb-3">
        <li><strong>IP / host en NetControl</strong> = mismo concepto que “IP/Host” en MikroWisp: la que usa el panel para <strong>API RouterOS</strong> (en tu red será <code>10.8.0.14</code>, <code>10.8.0.16</code>, etc., según asigne tu OpenVPN/WireGuard/L2TP).</li>
    ...
    <ol class="small mb-3 ps-3">
        ...
        <li class="mb-2">La <strong>VM hub</strong> termina el túnel WireGuard y asigna al cliente la IP <strong><code>10.8.0.x</code></strong>.</li>
        <li class="mb-2">El servidor <strong>NetControl</strong> (PHP) debe alcanzar <strong>TCP 8728</strong> (API) hacia <strong><code>10.8.0.x</code></strong>: o bien hay ruta desde la LAN del panel hasta <code>10.8.0.0/24</code>, o el panel corre en la misma red que el hub y resuelve la ruta en el MikroTik central.</li>
    </ol>
